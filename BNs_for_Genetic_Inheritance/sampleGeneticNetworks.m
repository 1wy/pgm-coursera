...
phenotypeFactor2 = phenotypeGivenGenotypeMendelianFactor(isDominant, genotypeVar, phenotypeVar);
...
phenotypeFactorAlpha2 = phenotypeGivenGenotypeFactor(alphaList, genotypeVar, phenotypeVar);
...
genotypeFactor2 = genotypeGivenAlleleFreqsFactor(alleleFreqs, genotypeVar);
...
genotypeFactorPar2 = genotypeGivenParentsGenotypesFactor(numAlleles, genotypeVarChild, genotypeVarParentOne, genotypeVarParentTwo);
...
sampleFactorList2 = constructGeneticNetwork(pedigree, alleleFreqs, alphaList);
...
phenotypeFactorSigmoid2 = constructSigmoidPhenotypeFactor(alleleWeights, geneCopyVarParentOneList, geneCopyVarParentTwoList, phenotypeVar);