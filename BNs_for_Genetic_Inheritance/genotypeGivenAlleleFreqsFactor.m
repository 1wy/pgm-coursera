...
genotypeFactor.card = [N*(N+1)/2];

probabilityGenotypes = alleleFreqs * alleleFreqs';
idx = tril(ones(size(probabilityGenotypes)));
probabilityGenotypes = probabilityGenotypes(:);
probabilityGenotypes = probabilityGenotypes(logical(idx(:)));
probabilityGenotypes(2:end-1) = probabilityGenotypes(2:end-1) * 2;
genotypeFactor.val = probabilityGenotypes';
