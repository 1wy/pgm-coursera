...
len_val = prod(phenotypeFactor.card);
phenotypeFactor.val = zeros(1, len_val);
% Replace the zeros in phentoypeFactor.val with the correct values.
phenotypeFactor.val(1:2:len_val) = alphaList;
phenotypeFactor.val(2:2:len_val) = 1 - alphaList;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
end