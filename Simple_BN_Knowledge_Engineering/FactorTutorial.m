...
% Factor Product
FACTORS.PRODUCT2 = FactorProduct(FACTORS.INPUT(1), FACTORS.INPUT(2));
...
FACTORS.MARGINALIZATION2 = FactorMarginalization(FACTORS.INPUT(2), [2]);
FACTORS.MARGINALIZATION = struct('var', [1], 'card', [2], 'val', [1 1]); 

% Observe Evidence
FACTORS.EVIDENCE2 = ObserveEvidence(FACTORS.INPUT, [2 1; 3 2]);
