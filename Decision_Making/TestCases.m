...
euf = CalculateExpectedUtilityFactor(FullI);
PrintFactor(euf);
...
load TestI0.mat;
[meu0 optdr] = OptimizeWithJointUtility(TestI0);
dollor0 = exp(meu0 / 100) - 1;

TestI0.DecisionFactors(1) = struct('var', [9, 11], 'card', [2, 2], 'val', [1, 0, 0, 1]);
[meu1 optdr] = OptimizeWithJointUtility(TestI0);
exp((meu1-meu0) / 100) - 1

TestI0.RandomFactors(10) = struct('var', [11, 1], 'card', [2, 2], 'val', [0.999, 0.001, 0.25, 0.75]);
[meu2 optdr] = OptimizeWithJointUtility(TestI0);
exp((meu2 - meu0) / 100) - 1

TestI0.RandomFactors(10) = struct('var', [11, 1], 'card', [2, 2], 'val', [0.999, 0.001, 0.001, 0.999]);
[meu3 optdr] = OptimizeWithJointUtility(TestI0);
exp((meu3 - meu0) / 100) - 1
